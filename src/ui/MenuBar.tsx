  ...
  const buildMenus = (): { title: string; items: () => ContextMenuItem[] }[] => [
    {
      ...
      items: () => [
        ...
        { label: 'Import FCPXML / Premiere XML...', onSelect: () => void cmd.importXmlFile() },
        ...
        { separator: true },
        {
          ...
          submenu: [
            ...
            { label: 'Add Active Sequence to Render Queue', onSelect: () => cmd.addToRenderQueue() },
            ...
            { label: 'Final Cut Pro XML (FCPXML)...', onSelect: () => void cmd.exportFcpxml() },
            { label: 'Premiere Pro XML...', onSelect: () => void cmd.exportPremiereXml() },
    ...
    },
    {
      ...
      items: () => [
        ...
        { separator: true },
        { label: 'Render and Replace...', disabled: !hasSel, onSelect: () => void cmd.renderAndReplace() },
        { label: 'Restore Unrendered Clip', disabled: !hasSel, onSelect: () => cmd.restoreUnrenderedClip() },
        { separator: true },
        { label: 'Create J-Cut (Audio Lead)...', disabled: !hasSel, onSelect: () => cmd.createJCut(30) },
        { label: 'Create L-Cut (Audio Lag)...', disabled: !hasSel, onSelect: () => cmd.createLCut(30) },
        { separator: true },
        { label: 'Create Multicam Sequence from Project Selection...', onSelect: () => void cmd.createMulticamSequence() },
        { label: 'Mix to Target Loudness...', onSelect: () => void cmd.mixToTargetLoudness() },
        { separator: true },
